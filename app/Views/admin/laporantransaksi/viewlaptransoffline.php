...
<div class="card">
  <div class="card-header">
    <?= form_button('', '<i class="fas fa-sync-alt"></i> Refresh', [
      ...
      'onclick' => "location.href=('" . site_url('/admin/laporan/cetak-transaksi-offline') . "')"
    ]); ?>
  </div>
  <div class="card-body">
    <!-- STACKED BAR CHART -->
    <div class="row">
      <div class="col-md-4">
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <?= form_open(base_url('/admin/laporan/cetak-laporan-transaksi-offline-periode')); ?>
      ...
      <div class="col-lg-8">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Grafik Laporan Transaksi Offline</h3>
          </div>
          <div class="card-body">
            <div class="form-group">
...
<script>
  function tampilgrafik() {
    $.ajax({
      type: "post",
      url: "<?= site_url('/admin/laporan/tampilgrafiktransaksioffline'); ?>",
      data: {
        bulan: $('#bulan').val()
      },
      dataType: "json",
